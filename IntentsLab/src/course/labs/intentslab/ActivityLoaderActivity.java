...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent expLoadAct = new Intent(this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		Intent imp = new Intent(Intent.ACTION_VIEW, Uri.parse(URL));
		...
		Intent chooserIntent = Intent.createChooser(imp, CHOOSER_TEXT);
